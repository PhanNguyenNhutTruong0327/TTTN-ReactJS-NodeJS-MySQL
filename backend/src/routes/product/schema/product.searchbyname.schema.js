const getSearchProductPaginationSchema = {
    description: 'Get search product by name with pagination',
    tags: ['product'],
    summary: 'Get search product by name with pagination',
    // params: {
    //     type: 'object',
    //     required: ['id'],
    //     properties: {
...
module.exports = getSearchProductPaginationSchema;