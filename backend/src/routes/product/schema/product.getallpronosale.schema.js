const getAllProductNotSaleSchema = {
    description: 'Get all product not sale with pagination',
    tags: ['product'],
    summary: 'Get all product not sale pagination',
    querystring: {
        type: 'object',
        properties: {
...
module.exports = getAllProductNotSaleSchema;