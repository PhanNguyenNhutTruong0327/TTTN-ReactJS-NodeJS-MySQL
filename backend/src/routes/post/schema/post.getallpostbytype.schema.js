const getAllPostByTypeSchema = {
    description: 'Get all post by type with pagination',
    tags: ['post'],
    summary: 'Get all post by type with pagination',
    querystring: {
        type: 'object',
        properties: {
...
module.exports = getAllPostByTypeSchema;