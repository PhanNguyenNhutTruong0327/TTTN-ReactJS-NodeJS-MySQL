const getPostBySlugTopicSchema = {
    description: 'Get all post by slug of topic with pagination',
    tags: ['post'],
    summary: 'Get all post by slug of topic with pagination',
    querystring: {
        type: 'object',
        properties: {
...
module.exports = getPostBySlugTopicSchema;