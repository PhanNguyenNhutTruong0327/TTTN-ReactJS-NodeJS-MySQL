const getTrashDiscountedProductsSchema = {
    description: 'Get list trash discounted_products',
    tags: ['discounted_products'],
    summary: 'Get list trash discounted_products',
    querystring: {
        type: 'object',
        properties: {
...
module.exports = getTrashDiscountedProductsSchema;