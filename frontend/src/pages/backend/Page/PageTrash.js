...
function PageTrash() {
    ...
    useEffect(() => {
        apiPost.getListTrash('page', page, limit).then((res) => {
            try {
                            ...
                            <div className="row">
                                ...
                                <ul className="pagination">
                                    <li className="page-item">
                                        {page > 1 ? (
                                            <Link className="page-link" to={`/admin/page/list-trash/${page - 1}/${limit}`}>Previous</Link>
                                        ) : (
                                    ...
                                    {Array.from(Array(pages).keys()).map((index) => (
                                        ...
                                        >
                                            <Link
                                                ...
                                                to={`/admin/page/list-trash/${index + 1}/${limit}`}
                                            >
                                                {index + 1}
                                            </Link>
                                        </li>
                                    ...
                                    <li className="page-item">
                                        <Link className="page-link" to={`/admin/page/list-trash/${page + 1}/${limit}`}>
                                            Next
                                        </Link>
                                    </li>
                                </ul>
