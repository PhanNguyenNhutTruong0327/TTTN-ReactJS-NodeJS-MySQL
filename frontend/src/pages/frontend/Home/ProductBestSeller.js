...
import product_1 from '../../../assets/frontend/images/product/iphone-13.jpg';
...
function ProductBestSeller() {
    ...
    useEffect(() => {
        apiProduct.getProductBestSeller().then((res) => {
            try {
                setData(res.data);
        ...
        return (
            <section className="padding-bottom">
                <header className="section-heading heading-line">
                    <h4 className="title-section text-uppercase">sản phẩm bán chạy</h4>
                </header>
