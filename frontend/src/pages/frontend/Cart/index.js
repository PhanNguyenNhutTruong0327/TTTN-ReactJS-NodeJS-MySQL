...
import img_pro_2 from "../../../assets/frontend/images/product/iphone-15.jpg";
    ...
    return (
        <section className="section-content padding-y">
            <div className="container">
                {token == null ? (<div className="row" style={{ height: "300px" }}>
                        ...
                        <main className="col-md-9">
                            <div className="card">
                                    ...
                                    <tbody>
                                        {userItems.map((item, index) => (
                                            <tr>
                                                {console.log(item)}
                                                <td>
                                                    <figure className="itemside" key={index + 1}>
                                                        <div className="aside"><img src={imageURL + item.image} className="img-sm" style={{ height: "80px", width: "80px" }} /></div>
                                                        <figcaption className="info">
                                                            <Link to={`/san-pham/chi-tiet-san-pham/${item.slug}`} className="title text-dark">{item.name}</Link>
                                                            <p className="text-muted small">
                                                                {/* Size: XL, Color: blue, <br />  */}
                                                                Hãng: {item.nameBrand}</p>
                                                        </figcaption>
                                                    </figure>
                                                </td>
                                                <td>
                                                ...
                                                <td className="text-right">
                                                    {/* <a data-original-title="Save to Wishlist" title="" href="" className="btn btn-light"
                                ...
                                <div className="card-body border-top">
                                    {/* <a href="#" className="btn btn-primary float-md-right"> Make Purchase
                                <i className="fa fa-chevron-right"></i>
                            </a> */}
                                    <Link to="/" className="btn btn-light"> <i className="fa fa-chevron-left"></i> Tiếp tục mua hàng </Link>
                                </div>
                            </div>

                            <div className="alert alert-success mt-3" style={{ backgroundColor: "#ccf0d1", borderColor: "#ccf0d1" }}>
                                <p className="icontext" style={{ color: "#005e0c" }}><i className="icon text-success fa fa-truck"></i> Free Delivery within 1-2 weeks
                                </p>
                            </div>
